...
namespace RealEstate.API.Migrations.Repository
{
    ...
    [Migration("20210615134216_RatingsDoneByMeFix")]
    partial class RatingsDoneByMeFix
    {
            ...
            modelBuilder.Entity("Entities.Models.Advertisment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 6, 15, 15, 42, 16, 304, DateTimeKind.Local).AddTicks(9503),
                        ...
                        new
                        {
                            ...
                            CanBeSold = false,
                            Contact = "0888-888-888",
                            CreatedOn = new DateTime(2021, 6, 15, 15, 42, 16, 307, DateTimeKind.Local).AddTicks(3987),
                        ...
                        new
                        {
                            ...
                            CanBeSold = false,
                            Contact = "0888-888-888",
                            CreatedOn = new DateTime(2021, 6, 15, 15, 42, 16, 307, DateTimeKind.Local).AddTicks(4021),
            ...
            modelBuilder.Entity("Entities.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 6, 15, 15, 42, 16, 307, DateTimeKind.Local).AddTicks(4970),
                            PropertyId = new Guid("e277bec0-2f9d-40c6-9433-f7c6ecfa7ada")
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 6, 15, 15, 42, 16, 307, DateTimeKind.Local).AddTicks(5698),
                            PropertyId = new Guid("e277bec0-2f9d-40c6-9433-f7c6ecfa7ada")
                        },
                        new
                        {
                            Id = new Guid("7e6d5379-9f9e-4bf6-9744-7623008c943e"),
                            Content = "Bra pris.",
                            CreatedOn = new DateTime(2021, 6, 15, 15, 42, 16, 307, DateTimeKind.Local).AddTicks(5712),
                            PropertyId = new Guid("e277bec0-2f9d-40c6-9433-f7c6ecfa7ada")
                        });
                });
