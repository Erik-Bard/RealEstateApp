...
namespace RealEstate.API.Migrations.Repository
{
    ...
    [Migration("20210615150254_UserDtoUpdate")]
            ...
            modelBuilder.Entity("Entities.Models.Advertisment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 6, 15, 17, 2, 53, 695, DateTimeKind.Local).AddTicks(1776),
                        ...
                        new
                        {
                            ...
                            CanBeSold = false,
                            Contact = "0888-888-888",
                            CreatedOn = new DateTime(2021, 6, 15, 17, 2, 53, 697, DateTimeKind.Local).AddTicks(5251),
                        ...
                        new
                        {
                            ...
                            CanBeSold = false,
                            Contact = "0888-888-888",
                            CreatedOn = new DateTime(2021, 6, 15, 17, 2, 53, 697, DateTimeKind.Local).AddTicks(5331),
            ...
            modelBuilder.Entity("Entities.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 6, 15, 17, 2, 53, 697, DateTimeKind.Local).AddTicks(6222),
                            PropertyId = new Guid("e277bec0-2f9d-40c6-9433-f7c6ecfa7ada")
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 6, 15, 17, 2, 53, 697, DateTimeKind.Local).AddTicks(6915),
                            PropertyId = new Guid("e277bec0-2f9d-40c6-9433-f7c6ecfa7ada")
                        },
                        new
                        {
                            Id = new Guid("7e6d5379-9f9e-4bf6-9744-7623008c943e"),
                            Content = "Bra pris.",
                            CreatedOn = new DateTime(2021, 6, 15, 17, 2, 53, 697, DateTimeKind.Local).AddTicks(6931),
                            PropertyId = new Guid("e277bec0-2f9d-40c6-9433-f7c6ecfa7ada")
                        });
                });
