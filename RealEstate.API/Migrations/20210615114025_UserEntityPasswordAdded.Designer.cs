...
namespace RealEstate.API.Migrations.Repository
{
    ...
    [Migration("20210615114025_UserEntityPasswordAdded")]
    partial class UserEntityPasswordAdded
    {
            ...
            modelBuilder.Entity("Entities.Models.Advertisment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 6, 15, 13, 40, 25, 87, DateTimeKind.Local).AddTicks(6044),
                        ...
                        new
                        {
                            ...
                            CanBeSold = false,
                            Contact = "0888-888-888",
                            CreatedOn = new DateTime(2021, 6, 15, 13, 40, 25, 90, DateTimeKind.Local).AddTicks(2111),
                        ...
                        new
                        {
                            ...
                            CanBeSold = false,
                            Contact = "0888-888-888",
                            CreatedOn = new DateTime(2021, 6, 15, 13, 40, 25, 90, DateTimeKind.Local).AddTicks(2150),
            ...
            modelBuilder.Entity("Entities.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 6, 15, 13, 40, 25, 90, DateTimeKind.Local).AddTicks(3241),
                            PropertyId = new Guid("e277bec0-2f9d-40c6-9433-f7c6ecfa7ada")
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 6, 15, 13, 40, 25, 90, DateTimeKind.Local).AddTicks(3980),
                            PropertyId = new Guid("e277bec0-2f9d-40c6-9433-f7c6ecfa7ada")
                        },
                        new
                        {
                            Id = new Guid("7e6d5379-9f9e-4bf6-9744-7623008c943e"),
                            Content = "Bra pris.",
                            CreatedOn = new DateTime(2021, 6, 15, 13, 40, 25, 90, DateTimeKind.Local).AddTicks(3993),
                            PropertyId = new Guid("e277bec0-2f9d-40c6-9433-f7c6ecfa7ada")
                        });
                });
