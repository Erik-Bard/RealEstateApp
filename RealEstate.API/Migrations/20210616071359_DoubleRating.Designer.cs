...
namespace RealEstate.API.Migrations.Repository
{
    ...
    [Migration("20210616071359_DoubleRating")]
            ...
            modelBuilder.Entity("Entities.Models.Advertisment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 6, 16, 9, 13, 59, 287, DateTimeKind.Local).AddTicks(1886),
                        ...
                        new
                        {
                            ...
                            CanBeSold = false,
                            Contact = "0888-888-888",
                            CreatedOn = new DateTime(2021, 6, 16, 9, 13, 59, 289, DateTimeKind.Local).AddTicks(5767),
                        ...
                        new
                        {
                            ...
                            CanBeSold = false,
                            Contact = "0888-888-888",
                            CreatedOn = new DateTime(2021, 6, 16, 9, 13, 59, 289, DateTimeKind.Local).AddTicks(5804),
            ...
            modelBuilder.Entity("Entities.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 6, 16, 9, 13, 59, 289, DateTimeKind.Local).AddTicks(6777),
                            PropertyId = new Guid("e277bec0-2f9d-40c6-9433-f7c6ecfa7ada")
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 6, 16, 9, 13, 59, 289, DateTimeKind.Local).AddTicks(7458),
                            PropertyId = new Guid("e277bec0-2f9d-40c6-9433-f7c6ecfa7ada")
                        },
                        new
                        {
                            Id = new Guid("7e6d5379-9f9e-4bf6-9744-7623008c943e"),
                            Content = "Bra pris.",
                            CreatedOn = new DateTime(2021, 6, 16, 9, 13, 59, 289, DateTimeKind.Local).AddTicks(7471),
                            PropertyId = new Guid("e277bec0-2f9d-40c6-9433-f7c6ecfa7ada")
                        });
                });
